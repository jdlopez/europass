...
/**
 * <p>Clase Java para MetadataListType complex type.
 * 
...
@XmlType(name = "MetadataListType", namespace = "http://europass.cedefop.europa.eu/Europass", propOrder = {
    "metadata"
})
public class MetadataListType {

    @XmlElement(name = "Metadata", namespace = "http://europass.cedefop.europa.eu/Europass", required = true)
