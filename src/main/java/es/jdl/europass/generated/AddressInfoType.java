...
@XmlType(name = "AddressInfoType", namespace = "http://europass.cedefop.europa.eu/Europass", propOrder = {
    "addressLine",
    "addressLine2",
    "postalCode",
    "municipality",
...
public class AddressInfoType {
    ...
    @XmlElement(name = "AddressLine", namespace = "http://europass.cedefop.europa.eu/Europass")
    protected String addressLine;
    @XmlElement(name = "AddressLine2", namespace = "http://europass.cedefop.europa.eu/Europass")
    protected String addressLine2;
    @XmlElement(name = "PostalCode", namespace = "http://europass.cedefop.europa.eu/Europass")
    protected String postalCode;
    @XmlElement(name = "Municipality", namespace = "http://europass.cedefop.europa.eu/Europass")
    protected String municipality;
    @XmlElement(name = "Country", namespace = "http://europass.cedefop.europa.eu/Europass")
