 ...
 * 			
 * 
 * <p>Clase Java para CertificateListType complex type.
 * 
...
@XmlType(name = "CertificateListType", namespace = "http://europass.cedefop.europa.eu/Europass", propOrder = {
    "certificate"
})
@XmlSeeAlso({
    LinguisticCertificateListType.class,
    ComputerCertificateListType.class
})
public class CertificateListType {

    @XmlElement(name = "Certificate", namespace = "http://europass.cedefop.europa.eu/Europass")
