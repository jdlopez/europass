...
public class InterDocument {
    ...
    @JsonProperty("ref")
    private es.jdl.europass.domain.DocumentInfo.DocumentType ref;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("ref")
    public es.jdl.europass.domain.DocumentInfo.DocumentType getRef() {
        return ref;
    }

    @JsonProperty("ref")
    public void setRef(es.jdl.europass.domain.DocumentInfo.DocumentType ref) {
        this.ref = ref;
    }
