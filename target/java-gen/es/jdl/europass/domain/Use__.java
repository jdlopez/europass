...
public class Use__ {
    ...
    @JsonProperty("Code")
    public Use__.Code getCode() {
        return code;
    }

    @JsonProperty("Code")
    public void setCode(Use__.Code code) {
        this.code = code;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Use__) == false) {
            return false;
        }
        Use__ rhs = ((Use__) other);
    ...
    public enum Code {
        ...
        private final static Map<String, Use__.Code> CONSTANTS = new HashMap<String, Use__.Code>();

        static {
            for (Use__.Code c: values()) {
        ...
        @JsonCreator
        public static Use__.Code fromValue(String value) {
            Use__.Code constant = CONSTANTS.get(value);
            if (constant == null) {
