...
public class Gender {
    ...
    @JsonProperty("Code")
    public Gender.Code getCode() {
        return code;
    }

    @JsonProperty("Code")
    public void setCode(Gender.Code code) {
        this.code = code;
    }
    ...
    public enum Code {
        ...
        private final static Map<String, Gender.Code> CONSTANTS = new HashMap<String, Gender.Code>();

        static {
            for (Gender.Code c: values()) {
        ...
        @JsonCreator
        public static Gender.Code fromValue(String value) {
            Gender.Code constant = CONSTANTS.get(value);
            if (constant == null) {
